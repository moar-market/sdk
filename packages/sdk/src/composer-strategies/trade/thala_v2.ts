...
import type { SwapParams } from './../protocols/thala_v2'
...
import { swap } from './../protocols/thala_v2'
...
export async function openPosition(
  ...
  throw new Error('Thala v2 swap is not available')
...
/**
 * Closes an existing position by optionally depositing collateral, executing swaps,
 * repaying borrowed assets and closing the credit account
